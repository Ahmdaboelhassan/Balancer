...
namespace API.Migrations
{
    ...
    [Migration("20260702010039_addnewCostCentersIsDelete")]
    partial class addnewCostCentersIsDelete
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.DashboardSettings", b =>
                {
                    ...
                    b.Property<decimal>("AddOnExpensesTarget")
                        .HasColumnType("decimal(18,2)");

                    b.Property<bool>("ApplyOverBudgetToFunds")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Domain.Entities.EvaluationDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.JournalDetail", b =>
                {
                    ...
                    b.HasIndex("SecondCostCenterId");

                    b.ToTable("JournalDetails");
                });

            modelBuilder.Entity("Domain.Entities.JournalDetailCostCenter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Settings", b =>
                {
                    ...
                    b.Property<int?>("CurrentCashAccount")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("FixedAssetsAccount")
                        .HasColumnType("int");

                    b.Property<int?>("InvestmentAccount")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("NotBudgetCostCenter")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.JournalDetail", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.CostCenter", "SecondCostCenter")
                        .WithMany()
                        .HasForeignKey("SecondCostCenterId");
